...
/**
 * A real, sharp-decodable 1×1 transparent PNG — generated by sharp itself so
 * the fixture can never drift from what libvips accepts (sharp 0.35's stricter
 * libpng rejected the previous hand-crafted minimal PNG with a read error).
 */
